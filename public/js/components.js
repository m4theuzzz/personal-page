...
<div id="navigate">
    ...
    <div class="search">
        <div id="searchBox">
            ...
            <div class="dropdown">
                <a class="searchLink" href="#" role="button" id="dropdownMenuLink" onclick="document.getElementById('searchInput').focus();"></a>
                <input type="text" id="searchInput" placeholder="Pesquisar Repositórios" aria-describedby="searchIcon">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink" id="dropdownList">
                </ul>
            </div>
        </div>
    </div>
